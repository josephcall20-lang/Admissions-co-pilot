...
from src.routes.followup import followup_bp
from src.routes.simple_delete import simple_delete_bp
...
app.register_blueprint(simple_delete_bp, url_prefix='/api')
